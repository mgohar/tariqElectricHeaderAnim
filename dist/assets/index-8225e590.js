...
`,PT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/kiosk_.png"),LT=new Ot(4.1,3,.1),DT=new Pt({uniforms:{cityTexture:{value:PT},opacity:{value:1}},vertexShader:RT,fragmentShader:CT,transparent:!0}),Tp=new it(LT,DT);Tp.position.z=-100;const IT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/static.png");let Hl=new vi;for(let s=0;s<100;s++){let e=new Ot(.005,.005,1),t=new ei({map:IT,transparent:!1}),n=new it(e,t);n.position.x=Math.random()*(.6297152794826579- -.6934780919619608)+-.6934780919619608,n.position.y=Math.random()*(.3772087694566467- -.3990420461252948)+-.3990420461252948,n.position.z=Math.random()*(-109- -130)+-130,Hl.add(n)}co.add(Hl);const NT=`
varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,OT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame00.png"),FT=new Ot(3,3,.1),BT=new Pt({uniforms:{cityTexture:{value:OT},opacity:{value:1}},vertexShader:NT,fragmentShader:UT,transparent:!0}),uo=new it(FT,BT);uo.position.set(0,0,8);uo.scale.set(2.02,1.211);const Di=`
varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,zT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame0.png"),kT=new Ot(3,3,.1),HT=new Pt({uniforms:{cityTexture:{value:zT},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),ho=new it(kT,HT);ho.position.set(0,0,8);ho.scale.set(2.02,1.211);const GT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame1.png"),VT=new Ot(3,3,.1),WT=new Pt({uniforms:{cityTexture:{value:GT},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),fo=new it(VT,WT);fo.position.set(0,0,8);fo.scale.set(2.02,1.211);const XT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame2.png"),qT=new Ot(3,3,.1),YT=new Pt({uniforms:{cityTexture:{value:XT},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),po=new it(qT,YT);po.position.set(0,0,8);po.scale.set(2.02,1.211);const jT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame3.png"),KT=new Ot(3,3,.1),ZT=new Pt({uniforms:{cityTexture:{value:jT},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),mo=new it(KT,ZT);mo.position.set(0,0,8);mo.scale.set(2.02,1.211);const $T=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame4.png"),JT=new Ot(3,3,.1),QT=new Pt({uniforms:{cityTexture:{value:$T},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),_o=new it(JT,QT);_o.position.set(0,0,8);_o.scale.set(2.02,1.211);const eE=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame5.png"),tE=new Ot(3,3,.1),nE=new Pt({uniforms:{cityTexture:{value:eE},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),go=new it(tE,nE);go.position.set(0,0,8);go.scale.set(2.02,1.211);const iE=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame6.png"),rE=new Ot(3,3,.1),sE=new Pt({uniforms:{cityTexture:{value:iE},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),vo=new it(rE,sE);vo.position.set(0,0,8);vo.scale.set(2.02,1.211);const aE=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame7.png"),oE=new Ot(3,3,.1),cE=new Pt({uniforms:{cityTexture:{value:aE},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),xo=new it(oE,cE);xo.position.set(0,0,8);xo.scale.set(2.02,1.211);co.add(Sp,uo,ho,Tp,fo,po,mo,_o,go,vo,xo);var lE=new ad(new Ie("white"),10,10),uE=new Ny("#ffffff",10);co.add(uE,lE);let Xi=5,qi=3;console.log("window.innerWidth",window.innerWidth);window.innerWidth>1024?(Xi=5,qi=3):window.innerWidth>=992?(Xi=3,qi=1):window.innerWidth>=768||window.innerWidth>=576?(Xi=2,qi=-2):window.innerWidth>=480?(Xi=2,qi=-4):window.innerWidth>=200&&(Xi=1.8,qi=-6);const Ep=()=>{var s=ja.timeline();s.to(Xt.position,{z:-104.5,duration:1.1,delay:1,ease:"power1.inOut"}).to(Xt.position,{z:Xi,y:-.6,duration:6,ease:"power3.inOut",onStart:()=>{dE()}}).to(Xt.position,{z:qi,y:0,duration:1,ease:"power3.inOut"}),ja.to(Hl.position,{z:180,y:-.7,duration:5,delay:5.5,ease:"power2.outIn"}),s.to(uo.material.uniforms.opacity,{value:0,duration:.4,ease:"power1.outIn"},"+=1").to(ho.material.uniforms.opacity,{value:1,duration:.8,ease:"power1.outIn",onComplete:()=>{di()}},"-=2").to(fo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}},"-=0.5").to(po.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}}).to(mo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}}).to(_o.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}}).to(go.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}}).to(vo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}}).to(xo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}})},hE=new Oy;function bp(){hE.getElapsedTime(),fE(),kl.render(co,Xt),requestAnimationFrame(bp)}bp();new qy(1e3);document.addEventListener("keydown",s=>{_i[s.key]=!0});document.addEventListener("keyup",s=>{_i[s.key]=!1});function fE(){_i.ArrowUp&&(Xt.position.z-=.1),_i.ArrowDown&&(Xt.position.z+=.1),_i.ArrowLeft&&(Xt.position.y-=.1),_i.ArrowRight&&(Xt.position.y+=.1),_i.w&&(Xt.rotation.x+=.1*.02),_i.s&&(Xt.rotation.x-=.1*.02)}function di(){var s=document.getElementById("LightAudio");s.play()}function dE(){var s=document.getElementById("WhooshAudio");setTimeout(()=>{s.play()},1500)}let Qa=0;window.addEventListener("wheel",function(){Qa==0&&(Ep(),Qa++)});window.addEventListener("touchmove",function(){Qa==0&&(Ep(),Qa++)});
