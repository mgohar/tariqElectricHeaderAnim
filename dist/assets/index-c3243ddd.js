...
`,PT=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/kiosk_.png"),LT=new Ot(4.1,3,.1),DT=new Pt({uniforms:{cityTexture:{value:PT},opacity:{value:1}},vertexShader:RT,fragmentShader:CT,transparent:!0}),Or=new it(LT,DT);Or.position.z=-100;const IT=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/static.png");let Hl=new _i;for(let s=0;s<100;s++){let e=new Ot(.005,.005,1),t=new Qn({map:IT,transparent:!1}),n=new it(e,t);n.position.x=Math.random()*(.6297152794826579- -.6934780919619608)+-.6934780919619608,n.position.y=Math.random()*(.3772087694566467- -.3990420461252948)+-.3990420461252948,n.position.z=Math.random()*(-109- -130)+-130,Hl.add(n)}co.add(Hl);const NT=`
varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,OT=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame00.png"),FT=new Ot(3,3,.1),BT=new Pt({uniforms:{cityTexture:{value:OT},opacity:{value:1}},vertexShader:NT,fragmentShader:UT,transparent:!0}),uo=new it(FT,BT);uo.position.set(0,0,15);uo.scale.set(2.02,1.211);const Li=`
varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,zT=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame0.png"),kT=new Ot(3,3,.1),HT=new Pt({uniforms:{cityTexture:{value:zT},opacity:{value:0}},vertexShader:Li,fragmentShader:Di,transparent:!0}),ho=new it(kT,HT);ho.position.set(0,0,15);ho.scale.set(2.02,1.211);const GT=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame1.png"),VT=new Ot(3,3,.1),WT=new Pt({uniforms:{cityTexture:{value:GT},opacity:{value:0}},vertexShader:Li,fragmentShader:Di,transparent:!0}),fo=new it(VT,WT);fo.position.set(0,0,15);fo.scale.set(2.02,1.211);const XT=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame2.png"),qT=new Ot(3,3,.1),YT=new Pt({uniforms:{cityTexture:{value:XT},opacity:{value:0}},vertexShader:Li,fragmentShader:Di,transparent:!0}),po=new it(qT,YT);po.position.set(0,0,15);po.scale.set(2.02,1.211);const jT=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame3.png"),KT=new Ot(3,3,.1),ZT=new Pt({uniforms:{cityTexture:{value:jT},opacity:{value:0}},vertexShader:Li,fragmentShader:Di,transparent:!0}),mo=new it(KT,ZT);mo.position.set(0,0,15);mo.scale.set(2.02,1.211);const $T=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame4.png"),JT=new Ot(3,3,.1),QT=new Pt({uniforms:{cityTexture:{value:$T},opacity:{value:0}},vertexShader:Li,fragmentShader:Di,transparent:!0}),_o=new it(JT,QT);_o.position.set(0,0,15);_o.scale.set(2.02,1.211);const eE=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame5.png"),tE=new Ot(3,3,.1),nE=new Pt({uniforms:{cityTexture:{value:eE},opacity:{value:0}},vertexShader:Li,fragmentShader:Di,transparent:!0}),go=new it(tE,nE);go.position.set(0,0,15);go.scale.set(2.02,1.211);const iE=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame6.png"),rE=new Ot(3,3,.1),sE=new Pt({uniforms:{cityTexture:{value:iE},opacity:{value:0}},vertexShader:Li,fragmentShader:Di,transparent:!0}),vo=new it(rE,sE);vo.position.set(0,0,15);vo.scale.set(2.02,1.211);const aE=new sn().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.3/assets/images/model/frame7.png"),oE=new Ot(3,3,.1),cE=new Pt({uniforms:{cityTexture:{value:aE},opacity:{value:0}},vertexShader:Li,fragmentShader:Di,transparent:!0}),xo=new it(oE,cE);xo.position.set(0,0,15);xo.scale.set(2.02,1.211);co.add(Ep,uo,ho,Or,fo,po,mo,_o,go,vo,xo);var lE=new od(new Ie("white"),10,10),uE=new Ny("#ffffff",10);co.add(uE,lE);let Wi=12,Xi=10;console.log("window.innerWidth",window.innerWidth);window.innerWidth>1024?(Wi=12,Xi=10):window.innerWidth>=992?(Wi=10,Xi=8):window.innerWidth>=768?(Wi=9,Xi=7,Or.scale.set(.8,.8)):window.innerWidth>=576?(Wi=9,Xi=7,Or.scale.set(.7,.7)):window.innerWidth>=480?(Wi=8.5,Xi=5,Or.scale.set(.6,.6)):window.innerWidth>=200&&(Wi=7,Xi=1.8,Or.scale.set(.6,.6));const Gl=()=>{var s=Ka.timeline();s.to(bi.position,{z:-104.5,duration:1.1,delay:1,ease:"power1.inOut"}).to(bi.position,{z:Wi,y:-.6,duration:6,ease:"power3.inOut",onStart:()=>{fE()}}).to(bi.position,{z:Xi,y:0,duration:1,ease:"power3.inOut"}),Ka.to(Hl.position,{z:180,y:-.7,duration:5,delay:5.5,ease:"power2.outIn"}),s.to(uo.material.uniforms.opacity,{value:0,duration:.4,ease:"power1.outIn"},"+=1").to(ho.material.uniforms.opacity,{value:1,duration:.8,ease:"power1.outIn",onComplete:()=>{fi()}},"-=2").to(fo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{fi()}},"-=0.5").to(po.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{fi()}}).to(mo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{fi()}}).to(_o.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{fi()}}).to(go.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{fi()}}).to(vo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{fi()}}).to(xo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{fi()}})},hE=new Oy;function bp(){hE.getElapsedTime(),kl.render(co,bi),requestAnimationFrame(bp)}bp();new qy(1e3);document.addEventListener("keydown",s=>{Tp[s.key]=!0});document.addEventListener("keyup",s=>{Tp[s.key]=!1});function fi(){var s=document.getElementById("LightAudio");s.play()}function fE(){var s=document.getElementById("WhooshAudio");setTimeout(()=>{s.play()},1500)}let ss=0,dE=document.querySelector(".btn_audio_play");dE.addEventListener("click",()=>{ss==0&&(Gl(),ss++)});window.addEventListener("wheel",function(){ss==0&&(Gl(),ss++)});window.addEventListener("touchmove",function(){ss==0&&(Gl(),ss++)});
