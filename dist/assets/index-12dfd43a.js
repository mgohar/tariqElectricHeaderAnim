...
`)}function sx(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function ys(s){return s!==""}function oh(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ch(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const ax=/^[ \t]*#include +<([\w\d./]+)>/gm;function Pc(s){return s.replace(ax,cx)}const ox=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function cx(s,e){let t=Oe[e];if(t===void 0){const n=ox.get(e);if(n!==void 0)t=Oe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Pc(t)}const lx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function lh(s){return s.replace(lx,ux)}function ux(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function uh(s){let e="precision "+s.precision+` float;
precision `+s.precision+" int;";return s.precision==="highp"?e+=`
#define HIGH_PRECISION`:s.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:s.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function hx(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===gf?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Ip?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===jn&&(e="SHADOWMAP_TYPE_VSM"),e}function fx(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Xr:case qr:e="ENVMAP_TYPE_CUBE";break;case eo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function dx(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case qr:e="ENVMAP_MODE_REFRACTION";break}return e}function px(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case yf:e="ENVMAP_BLENDING_MULTIPLY";break;case Qp:e="ENVMAP_BLENDING_MIX";break;case em:e="ENVMAP_BLENDING_ADD";break}return e}function mx(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function _x(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=hx(t),l=fx(t),u=dx(t),h=px(t),f=mx(t),d=t.isWebGL2?"":ix(t),g=rx(r),_=i.createProgram();let m,p,M=t.glslVersion?"#version "+t.glslVersion+`
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var ti,ir,Fl,Vr,Es,Ia,$a,Is,yn="transform",Qc=yn+"Origin",pp,mp=function(e){var t=e.ownerDocument||e;for(!(yn in e.style)&&("msTransform"in e.style)&&(yn="msTransform",Qc=yn+"Origin");t.parentNode&&(t=t.parentNode););if(ir=window,$a=new Ws,t){ti=t,Fl=t.documentElement,Vr=t.body,Is=ti.createElementNS("http://www.w3.org/2000/svg","g"),Is.style.transform="none";var n=t.createElement("div"),i=t.createElement("div");Vr.appendChild(n),n.appendChild(i),n.style.position="static",n.style[yn]="translate3d(0,0,1px)",pp=i.offsetParent!==n,Vr.removeChild(n)}return t},lT=function(e){for(var t,n;e&&e!==Vr;)n=e._gsap,n&&n.uncache&&n.get(e,"x"),n&&!n.scaleX&&!n.scaleY&&n.renderTransform&&(n.scaleX=n.scaleY=1e-4,n.renderTransform(1,n),t?t.push(n):t=[n]),e=e.parentNode;return t},_p=[],gp=[],uT=function(){return ir.pageYOffset||ti.scrollTop||Fl.scrollTop||Vr.scrollTop||0},hT=function(){return ir.pageXOffset||ti.scrollLeft||Fl.scrollLeft||Vr.scrollLeft||0},Bl=function(e){return e.ownerSVGElement||((e.tagName+"").toLowerCase()==="svg"?e:null)},fT=function s(e){if(ir.getComputedStyle(e).position==="fixed")return!0;if(e=e.parentNode,e&&e.nodeType===1)return s(e)},xc=function s(e,t){if(e.parentNode&&(ti||mp(e))){var n=Bl(e),i=n?n.getAttribute("xmlns")||"http://www.w3.org/2000/svg":"http://www.w3.org/1999/xhtml",r=n?t?"rect":"g":"div",a=t!==2?0:100,o=t===3?100:0,c="position:absolute;display:block;pointer-events:none;margin:0;padding:0;",l=ti.createElementNS?ti.createElementNS(i.replace(/^https/,"http"),r):ti.createElement(r);return t&&(n?(Ia||(Ia=s(e)),l.setAttribute("width",.01),l.setAttribute("height",.01),l.setAttribute("transform","translate("+a+","+o+")"),Ia.appendChild(l)):(Es||(Es=s(e),Es.style.cssText=c),l.style.cssText=c+"width:0.1px;height:0.1px;top:"+o+"px;left:"+a+"px",Es.appendChild(l))),l}throw"Need document and parent."},dT=function(e){for(var t=new Ws,n=0;n<e.numberOfItems;n++)t.multiply(e.getItem(n).matrix);return t},pT=function(e){var t=e.getCTM(),n;return t||(n=e.style[yn],e.style[yn]="none",e.appendChild(Is),t=Is.getCTM(),e.removeChild(Is),n?e.style[yn]=n:e.style.removeProperty(yn.replace(/([A-Z])/g,"-$1").toLowerCase())),t||$a.clone()},mT=function(e,t){var n=Bl(e),i=e===n,r=n?_p:gp,a=e.parentNode,o,c,l,u,h,f;if(e===ir)return e;if(r.length||r.push(xc(e,1),xc(e,2),xc(e,3)),o=n?Ia:Es,n)i?(l=pT(e),u=-l.e/l.a,h=-l.f/l.d,c=$a):e.getBBox?(l=e.getBBox(),c=e.transform?e.transform.baseVal:{},c=c.numberOfItems?c.numberOfItems>1?dT(c):c.getItem(0).matrix:$a,u=c.a*l.x+c.c*l.y,h=c.b*l.x+c.d*l.y):(c=new Ws,u=h=0),t&&e.tagName.toLowerCase()==="g"&&(u=h=0),(i?n:a).appendChild(o),o.setAttribute("transform","matrix("+c.a+","+c.b+","+c.c+","+c.d+","+(c.e+u)+","+(c.f+h)+")");else{if(u=h=0,pp)for(c=e.offsetParent,l=e;l&&(l=l.parentNode)&&l!==c&&l.parentNode;)(ir.getComputedStyle(l)[yn]+"").length>4&&(u=l.offsetLeft,h=l.offsetTop,l=0);if(f=ir.getComputedStyle(e),f.position!=="absolute"&&f.position!=="fixed")for(c=e.offsetParent;a&&a!==c;)u+=a.scrollLeft||0,h+=a.scrollTop||0,a=a.parentNode;l=o.style,l.top=e.offsetTop-h+"px",l.left=e.offsetLeft-u+"px",l[yn]=f[yn],l[Qc]=f[Qc],l.position=f.position==="fixed"?"fixed":"absolute",e.parentNode.appendChild(o)}return o},yc=function(e,t,n,i,r,a,o){return e.a=t,e.b=n,e.c=i,e.d=r,e.e=a,e.f=o,e},Ws=function(){function s(t,n,i,r,a,o){t===void 0&&(t=1),n===void 0&&(n=0),i===void 0&&(i=0),r===void 0&&(r=1),a===void 0&&(a=0),o===void 0&&(o=0),yc(this,t,n,i,r,a,o)}var e=s.prototype;return e.inverse=function(){var n=this.a,i=this.b,r=this.c,a=this.d,o=this.e,c=this.f,l=n*a-i*r||1e-10;return yc(this,a/l,-i/l,-r/l,n/l,(r*c-a*o)/l,-(n*c-i*o)/l)},e.multiply=function(n){var i=this.a,r=this.b,a=this.c,o=this.d,c=this.e,l=this.f,u=n.a,h=n.c,f=n.b,d=n.d,g=n.e,_=n.f;return yc(this,u*i+f*a,u*r+f*o,h*i+d*a,h*r+d*o,c+g*i+_*a,l+g*r+_*o)},e.clone=function(){return new s(this.a,this.b,this.c,this.d,this.e,this.f)},e.equals=function(n){var i=this.a,r=this.b,a=this.c,o=this.d,c=this.e,l=this.f;return i===n.a&&r===n.b&&a===n.c&&o===n.d&&c===n.e&&l===n.f},e.apply=function(n,i){i===void 0&&(i={});var r=n.x,a=n.y,o=this.a,c=this.b,l=this.c,u=this.d,h=this.e,f=this.f;return i.x=r*o+a*l+h||0,i.y=r*c+a*u+f||0,i},s}();function Wr(s,e,t,n){if(!s||!s.parentNode||(ti||mp(s)).documentElement===s)return new Ws;var i=lT(s),r=Bl(s),a=r?_p:gp,o=mT(s,t),c=a[0].getBoundingClientRect(),l=a[1].getBoundingClientRect(),u=a[2].getBoundingClientRect(),h=o.parentNode,f=!n&&fT(s),d=new Ws((l.left-c.left)/100,(l.top-c.top)/100,(u.left-c.left)/100,(u.top-c.top)/100,c.left+(f?0:hT()),c.top+(f?0:uT()));if(h.removeChild(o),i)for(c=i.length;c--;)l=i[c],l.scaleX=l.scaleY=0,l.renderTransform(1,l);return e?d.inverse():d}/*!
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var _T="x,translateX,left,marginLeft,xPercent".split(","),gT="y,translateY,top,marginTop,yPercent".split(","),vT=Math.PI/180,fn,vp,Dr,el,Mc,pf,xT=function(){return fn||typeof window<"u"&&(fn=window.gsap)&&fn.registerPlugin&&fn},xs=function(e,t,n,i){for(var r=t.length,a=i===2?0:i,o=0;o<r;o++)e[a]=parseFloat(t[o][n]),i===2&&(e[a+1]=0),a+=2;return e},Or=function(e,t,n){return parseFloat(e._gsap.get(e,t,n||"px"))||0},xp=function(e){var t=e[0],n=e[1],i;for(i=2;i<e.length;i+=2)t=e[i]+=t,n=e[i+1]+=n},mf=function(e,t,n,i,r,a,o,c,l){if(o.type==="cubic")t=[t];else{o.fromCurrent!==!1&&t.unshift(Or(n,i,c),r?Or(n,r,l):0),o.relative&&xp(t);var u=r?Jc:cT;t=[u(t,o.curviness)]}return t=a(yp(t,n,o)),Ja(e,n,i,t,"x",c),r&&Ja(e,n,r,t,"y",l),nr(t,o.resolution||(o.curviness===0?20:12))},yT=function(e){return e},MT=/[-+\.]*\d+\.?(?:e-|e\+)?\d*/g,_f=function(e,t,n){var i=Wr(e),r=0,a=0,o;return(e.tagName+"").toLowerCase()==="svg"?(o=e.viewBox.baseVal,o.width||(o={width:+e.getAttribute("width"),height:+e.getAttribute("height")})):o=t&&e.getBBox&&e.getBBox(),t&&t!=="auto"&&(r=t.push?t[0]*(o?o.width:e.offsetWidth||0):t.x,a=t.push?t[1]*(o?o.height:e.offsetHeight||0):t.y),n.apply(r||a?i.apply({x:r,y:a}):{x:i.e,y:i.f})},tl=function(e,t,n,i){var r=Wr(e.parentNode,!0,!0),a=r.clone().multiply(Wr(t)),o=_f(e,n,r),c=_f(t,i,r),l=c.x,u=c.y,h;return a.e=a.f=0,i==="auto"&&t.getTotalLength&&t.tagName.toLowerCase()==="path"&&(h=t.getAttribute("d").match(MT)||[],h=a.apply({x:+h[0],y:+h[1]}),l+=h.x,u+=h.y),h&&(h=a.apply(t.getBBox()),l-=h.x,u-=h.y),a.e=l-o.x,a.f=u-o.y,a},yp=function(e,t,n){var i=n.align,r=n.matrix,a=n.offsetX,o=n.offsetY,c=n.alignOrigin,l=e[0][0],u=e[0][1],h=Or(t,"x"),f=Or(t,"y"),d,g,_;return!e||!e.length?Da("M0,0L0,0"):(i&&(i==="self"||(d=el(i)[0]||t)===t?Ts(e,1,0,0,1,h-l,f-u):(c&&c[2]!==!1?fn.set(t,{transformOrigin:c[0]*100+"% "+c[1]*100+"%"}):c=[Or(t,"xPercent")/-100,Or(t,"yPercent")/-100],g=tl(t,d,c,"auto"),_=g.apply({x:l,y:u}),Ts(e,g.a,g.b,g.c,g.d,h+g.e-(_.x-g.e),f+g.f-(_.y-g.f)))),r?Ts(e,r.a,r.b,r.c,r.d,r.e,r.f):(a||o)&&Ts(e,1,0,0,1,a||0,o||0),e)},Ja=function(e,t,n,i,r,a){var o=t._gsap,c=o.harness,l=c&&c.aliases&&c.aliases[n],u=l&&l.indexOf(",")<0?l:n,h=e._pt=new vp(e._pt,t,u,0,0,yT,0,o.set(t,u,e));h.u=Dr(o.get(t,u,a))||0,h.path=i,h.pp=r,e._props.push(u)},ST=function(e,t){return function(n){return e||t!==1?fp(n,e,t):n}},Mp={version:"3.12.2",name:"motionPath",register:function(e,t,n){fn=e,Dr=fn.utils.getUnit,el=fn.utils.toArray,Mc=fn.core.getStyleSaver,pf=fn.core.reverting||function(){},vp=n},init:function(e,t,n){if(!fn)return console.warn("Please gsap.registerPlugin(MotionPathPlugin)"),!1;(!(typeof t=="object"&&!t.style)||!t.path)&&(t={path:t});var i=[],r=t,a=r.path,o=r.autoRotate,c=r.unitX,l=r.unitY,u=r.x,h=r.y,f=a[0],d=ST(t.start,"end"in t?t.end:1),g,_;if(this.rawPaths=i,this.target=e,this.tween=n,this.styles=Mc&&Mc(e,"transform"),(this.rotate=o||o===0)&&(this.rOffset=parseFloat(o)||0,this.radians=!!t.useRadians,this.rProp=t.rotation||"rotation",this.rSet=e._gsap.set(e,this.rProp,this),this.ru=Dr(e._gsap.get(e,this.rProp))||0),Array.isArray(a)&&!("closed"in a)&&typeof f!="number"){for(_ in f)!u&&~_T.indexOf(_)?u=_:!h&&~gT.indexOf(_)&&(h=_);u&&h?i.push(mf(this,xs(xs([],a,u,0),a,h,1),e,u,h,d,t,c||Dr(a[0][u]),l||Dr(a[0][h]))):u=h=0;for(_ in f)_!==u&&_!==h&&i.push(mf(this,xs([],a,_,2),e,_,0,d,t,Dr(a[0][_])))}else g=d(yp(Da(t.path),e,t)),nr(g,t.resolution),i.push(g),Ja(this,e,t.x||"x",g,"x",t.unitX||"px"),Ja(this,e,t.y||"y",g,"y",t.unitY||"px")},render:function(e,t){var n=t.rawPaths,i=n.length,r=t._pt;if(t.tween._time||!pf()){for(e>1?e=1:e<0&&(e=0);i--;)df(n[i],e,!i&&t.rotate,n[i]);for(;r;)r.set(r.t,r.p,r.path[r.pp]+r.u,r.d,e),r=r._next;t.rotate&&t.rSet(t.target,t.rProp,n[0].angle*(t.radians?vT:1)+t.rOffset+t.ru,t,e)}else t.styles.revert()},getLength:function(e){return nr(Da(e)).totalLength},sliceRawPath:fp,getRawPath:Da,pointsToSegment:Jc,stringToRawPath:Za,rawPathToString:dp,transformRawPath:Ts,getGlobalMatrix:Wr,getPositionOnPath:df,cacheRawPathMeasurements:nr,convertToPath:function(e,t){return el(e).map(function(n){return sT(n,t!==!1)})},convertCoordinates:function(e,t,n){var i=Wr(t,!0,!0).multiply(Wr(e));return n?i.apply(n):i},getAlignMatrix:tl,getRelativePosition:function(e,t,n,i){var r=tl(e,t,n,i);return{x:r.e,y:r.f}},arrayToRawPath:function(e,t){t=t||{};var n=xs(xs([],e,t.x||"x",0),e,t.y||"y",1);return t.relative&&xp(n),[t.type==="cubic"?n:Jc(n,t.curviness)]}};xT()&&fn.registerPlugin(Mp);ja.registerPlugin(Mp);let zl,_i={};zl=document.querySelector("canvas");new Ky;var kl=new Zf({canvas:zl,powerPreference:"high-performance",alpha:!0,antialias:!0,stencil:!1,depth:!0});kl.setSize(window.innerWidth,window.innerHeight);var co=new Xx,Xt=new Ht(45,window.innerWidth/window.innerHeight,.001,1e3);Xt.position.z=-104;const TT=new jy(Xt,zl);TT.enabled=!1;window.addEventListener("resize",function(){kl.setSize(window.innerWidth,window.innerHeight),Xt.aspect=window.innerWidth/window.innerHeight,Xt.updateProjectionMatrix()});var ET=[new L(0,0,-100),new L(0,0,0)],bT=new td(ET),AT=30,wT=new ml(bT,300,1,AT,!0),lo=new ei({side:Gt,map:new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/assets/images/bg_texture.png")});lo.map.wrapS=wi;lo.map.wrapT=wi;lo.map.repeat.set(1,1);var Sp=new it(wT,lo);Sp.matrixAutoUpdate=!0;const RT=`
varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,PT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/kiosk_.png"),LT=new Ot(4.1,3,.1),DT=new Pt({uniforms:{cityTexture:{value:PT},opacity:{value:1}},vertexShader:RT,fragmentShader:CT,transparent:!0}),Tp=new it(LT,DT);Tp.position.z=-100;const IT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/static.png");let Hl=new vi;for(let s=0;s<100;s++){let e=new Ot(.005,.005,1),t=new ei({map:IT,transparent:!1}),n=new it(e,t);n.position.x=Math.random()*(.6297152794826579- -.6934780919619608)+-.6934780919619608,n.position.y=Math.random()*(.3772087694566467- -.3990420461252948)+-.3990420461252948,n.position.z=Math.random()*(-109- -130)+-130,Hl.add(n)}co.add(Hl);const NT=`
varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,OT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/assets/images/model/frame00.png"),FT=new Ot(3,3,.1),BT=new Pt({uniforms:{cityTexture:{value:OT},opacity:{value:1}},vertexShader:NT,fragmentShader:UT,transparent:!0}),uo=new it(FT,BT);uo.position.set(0,0,8);uo.scale.set(2.02,1.211);const Di=`
varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,zT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/assets/images/model/frame0.png"),kT=new Ot(3,3,.1),HT=new Pt({uniforms:{cityTexture:{value:zT},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),ho=new it(kT,HT);ho.position.set(0,0,8);ho.scale.set(2.02,1.211);const GT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/assets/images/model/frame1.png"),VT=new Ot(3,3,.1),WT=new Pt({uniforms:{cityTexture:{value:GT},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),fo=new it(VT,WT);fo.position.set(0,0,8);fo.scale.set(2.02,1.211);const XT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/assets/images/model/frame2.png"),qT=new Ot(3,3,.1),YT=new Pt({uniforms:{cityTexture:{value:XT},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),po=new it(qT,YT);po.position.set(0,0,8);po.scale.set(2.02,1.211);const jT=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/assets/images/model/frame3.png"),KT=new Ot(3,3,.1),ZT=new Pt({uniforms:{cityTexture:{value:jT},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),mo=new it(KT,ZT);mo.position.set(0,0,8);mo.scale.set(2.02,1.211);const $T=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/assets/images/model/frame4.png"),JT=new Ot(3,3,.1),QT=new Pt({uniforms:{cityTexture:{value:$T},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),_o=new it(JT,QT);_o.position.set(0,0,8);_o.scale.set(2.02,1.211);const eE=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/assets/images/model/frame5.png"),tE=new Ot(3,3,.1),nE=new Pt({uniforms:{cityTexture:{value:eE},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),go=new it(tE,nE);go.position.set(0,0,8);go.scale.set(2.02,1.211);const iE=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/assets/images/model/frame6.png"),rE=new Ot(3,3,.1),sE=new Pt({uniforms:{cityTexture:{value:iE},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),vo=new it(rE,sE);vo.position.set(0,0,8);vo.scale.set(2.02,1.211);const aE=new an().load("https://cdn.jsdelivr.net/gh/mgohar/tariqElectricHeaderAnim@0.0.1/assets/images/model/frame7.png"),oE=new Ot(3,3,.1),cE=new Pt({uniforms:{cityTexture:{value:aE},opacity:{value:0}},vertexShader:Di,fragmentShader:Ii,transparent:!0}),xo=new it(oE,cE);xo.position.set(0,0,8);xo.scale.set(2.02,1.211);co.add(Sp,uo,ho,Tp,fo,po,mo,_o,go,vo,xo);var lE=new ad(new Ie("white"),10,10),uE=new Ny("#ffffff",10);co.add(uE,lE);let Xi=5,qi=3;console.log("window.innerWidth",window.innerWidth);window.innerWidth>1024?(Xi=5,qi=3):window.innerWidth>=992?(Xi=3,qi=1):window.innerWidth>=768||window.innerWidth>=576?(Xi=2,qi=-2):window.innerWidth>=480?(Xi=2,qi=-4):window.innerWidth>=200&&(Xi=1.8,qi=-6);const Ep=()=>{var s=ja.timeline();s.to(Xt.position,{z:-104.5,duration:1.1,delay:1,ease:"power1.inOut"}).to(Xt.position,{z:Xi,y:-.6,duration:6,ease:"power3.inOut",onStart:()=>{dE()}}).to(Xt.position,{z:qi,y:0,duration:1,ease:"power3.inOut"}),ja.to(Hl.position,{z:180,y:-.7,duration:5,delay:5.5,ease:"power2.outIn"}),s.to(uo.material.uniforms.opacity,{value:0,duration:.4,ease:"power1.outIn"},"+=1").to(ho.material.uniforms.opacity,{value:1,duration:.8,ease:"power1.outIn",onComplete:()=>{di()}},"-=2").to(fo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}},"-=0.5").to(po.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}}).to(mo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}}).to(_o.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}}).to(go.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}}).to(vo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}}).to(xo.material.uniforms.opacity,{value:1,duration:.4,ease:"power1.outIn",onStart:()=>{di()}})},hE=new Oy;function bp(){hE.getElapsedTime(),fE(),kl.render(co,Xt),requestAnimationFrame(bp)}bp();new qy(1e3);document.addEventListener("keydown",s=>{_i[s.key]=!0});document.addEventListener("keyup",s=>{_i[s.key]=!1});function fE(){_i.ArrowUp&&(Xt.position.z-=.1),_i.ArrowDown&&(Xt.position.z+=.1),_i.ArrowLeft&&(Xt.position.y-=.1),_i.ArrowRight&&(Xt.position.y+=.1),_i.w&&(Xt.rotation.x+=.1*.02),_i.s&&(Xt.rotation.x-=.1*.02)}function di(){var s=document.getElementById("LightAudio");s.play()}function dE(){var s=document.getElementById("WhooshAudio");setTimeout(()=>{s.play()},1500)}let Qa=0;window.addEventListener("wheel",function(){Qa==0&&(Ep(),Qa++)});window.addEventListener("touchmove",function(){Qa==0&&(Ep(),Qa++)});
